...
public class ProfileDAOTest {
	...
	private UserService userService;
	     ...
	     public void getUserByUsernameTest() { 
	        ...
	        assertEquals("Invalid user loaded",Integer.valueOf(7), userService.getUserByUsername("sebabanan").getId());
	        assertNotSame("Invalid user loaded",Integer.valueOf(8), userService.getUserByUsername("sebabanan").getId());
